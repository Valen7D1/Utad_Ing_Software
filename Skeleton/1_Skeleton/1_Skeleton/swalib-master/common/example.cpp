...
//-----------------------------------------------------------------------------
void Initialization(GLuint& texbkg, GLuint& texsmallball)
{
...
//-----------------------------------------------------------------------------
void Render(GLuint& texbkg, GLuint& texsmallball)
{
...
//-----------------------------------------------------------------------------
void Shutdown(GLuint& texbkg, GLuint& texsmallball)
{
	// Unload textures.
...
int Main(void)
{
	GLuint texbkg;
	GLuint texsmallball;
	Initialization(texbkg, texsmallball);

	while (!SYS_GottaQuit()) {	// Controlling a request to terminate an application.
		ProcessGameLogic();
		Render(texbkg, texsmallball);

		SYS_Pump();	// Process Windows messages.
		SYS_Sleep(17);	// To force 60 fps
	}

	Shutdown(texbkg, texsmallball);
